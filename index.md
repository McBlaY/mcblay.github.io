...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; }
  ...
  /* Profile */
  .profile { display:flex; gap:40px; align-items:center; padding:20px 0 24px; }
  ...
  .latest-card .card-thumb { flex:0 0 120px; width:120px; height:110px; background:#fff; display:flex; align-items:center; justify-content:center; overflow:hidden; }
  .latest-card .card-thumb img { width:100%; height:auto; object-fit:cover; display:block; }
  ...
  <div class="page-wrap">
    ...
    <div class="profile">
      <div style="display:flex;flex-direction:column;align-items:center;gap:10px;flex-shrink:0;">
        <img src="/assets/images/profile_pic.jpg" alt="Michel Torny" onerror="this.style.background='#444';this.removeAttribute('src')" style="width:220px;height:220px;border-radius:50%;object-fit:cover;background:var(--card-bg);">
      ...
      <div class="profile-text" style="align-self: center;">
        ...
        <p>I build AI/ML backbone for smart water utilities. As a renowned Research and Innovation leader, I deliver deployable AI/ML that finds leaks faster, forecasts demand better, detects anomalies earlier, and prioritizes maintenance before failure hits. I hold a PhD in HydroInformatics from NTNU with <a href="https://scholar.google.com/citations?user=Hoese+Michel+Tornyeviadzi" target="_blank">17 journal publications</a>, and I’ve delivered production-grade AI across water distribution networks. My work bridges AI/ML and operational reality: from DMA-agnostic Zeroshot methods to scalable custom deployments with industry partners, I’ve presented <a href="/about#presentations-guest-talks" target="_blank"> internationally</a> and delivered <a href="/about#presentations-guest-talks" target="_blank"> invited</a> talks.</p>
      </div>
    </div>
